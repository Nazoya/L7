...
storiesOf('地图方法', module)
  ...
  .add('高德地图2.0 line_arc3d_linear_demo', () => (
    <Amap2demo_arcLine3dLinear />
  ))
  .add('高德地图2.0 line_arc_greatCircle', () => (
    <Amap2demo_arcLine_greatCircle />
  ))
  .add('高德地图2.0 line_arc_greatCircleTex', () => (
    <Amap2demo_arcLine_greatCircleTex />
  ))
  ...
  .add('高德地图2.0 heatmap/hexagon/world', () => (
    <Amap2demo_heatmap_hexagon_world />
  ))
